...
There were many challenges that I faced when writting the application, but I must say that it's been so rewarding to learn so much in solving these challenges.
